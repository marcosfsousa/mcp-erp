...
*Amended 2026-08-21 by [#85](https://github.com/marcosfsousa/mcp-erp/issues/85).* **Two more assertions in `tests/wire/` are not over HTTP, and they are two further kinds of exception.** ~~One assertion~~ ~~Two~~ **Four**, in **three kinds**.
